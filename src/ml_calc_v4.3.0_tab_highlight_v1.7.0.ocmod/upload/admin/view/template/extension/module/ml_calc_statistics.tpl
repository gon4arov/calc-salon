    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $text_statistics; ?> (<?php echo $total; ?>)</a></li>
          <li><a href="#tab-email" data-toggle="tab"><?php echo $text_email_statistics; ?> (<?php echo $email_total; ?>)</a></li>
        </ul>
        <div class="tab-content" style="margin-top: 15px;">
          ...
          <div class="tab-pane" id="tab-email">
            <p class="text-muted"><?php echo sprintf($text_email_statistics_total, (int)$email_total); ?><?php if ($email_total > $email_limit) { ?> <?php echo sprintf($text_email_statistics_recent, (int)$email_limit); ?><?php } ?></p>
            <?php if ($email_statistics) { ?>
            <div class="table-responsive">
              <table class="table table-bordered table-hover">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php foreach ($email_statistics as $stat) { ?>
                  <tr>
                    <td class="text-left"><?php if (!empty($stat['product_url'])) { ?><a href="<?php echo htmlspecialchars($stat['product_url'], ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer"><?php echo htmlspecialchars($stat['product_name'], ENT_QUOTES, 'UTF-8'); ?></a><?php } else { echo htmlspecialchars($stat['product_name'], ENT_QUOTES, 'UTF-8'); } ?></td>
                    <td class="text-left"><?php echo $stat['email'] !== '' ? htmlspecialchars($stat['email'], ENT_QUOTES, 'UTF-8') : '-'; ?></td>
                    <td class="text-left"><?php echo htmlspecialchars($stat['ip_address'], ENT_QUOTES, 'UTF-8'); ?></td>
